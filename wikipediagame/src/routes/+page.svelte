...
>
    ...
    <div class="bg-black rounded-lg shadow-lg p-4 w-full flex flex-col gap-2">
      ...
      <div class="w-full flex">
        <div class="flex flex-col gap-2 w-full">
          <div class="flex">
            <button
              class="rounded-lg h-96 w-full shadow-md bg-red-500 overflow-clip text-white transition-all duration-250 hover:border-4 hover:bg-red-900 hover:shadow-blue-500 active:scale-95 hover:accent-blue-500 hover:shadow-xl border-blue-500 hover:"
            >
              <img class="w-full" src="https://picsum.photos/500/500" />
            </button>
            <button
              class="rounded-lg shadow-md p-4 ml-4 bg-neutral-500 overflow-clip text-white transition-all duration-250 hover:border-4 hover:bg-red-900 hover:shadow-blue-500 hover:scale-105 active:scale-95 hover:accent-blue-500 hover:shadow-xl border-blue-500 hover:"
            >
              <svg
          ...
          localhost:3000/execute/starlocalhost:3000/execute/startservertserver
          <h1 class="text-5xl">
            Articlelocalhost:3000/execute/startserver name
          </h1>
  ...
  <div
    class="bg-white text-black rounded-lg shadow-lg p-4 w-full flex flex-col gap-2 mt-auto"
  >
