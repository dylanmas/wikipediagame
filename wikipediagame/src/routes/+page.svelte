    ...
    <div class="bg-black rounded-lg shadow-lg p-4 w-full flex flex-col gap-2">
      ...
      <div class="w-full flex">
        <div class="flex flex-col gap-2 w-full">
          <div class="flex">
            <button
              class="rounded-lg h-48 w-full shadow-md bg-red-500 overflow-clip text-white transition-all duration-250 hover:border-4 hover:bg-red-900 hover:shadow-blue-500 active:scale-95 hover:accent-blue-500 hover:shadow-xl border-blue-500 hover:"
            >
